...
{
    public partial class ProductLDView : Form
    {
        ...
        {
            var newProduct = new ProductLDForm(currentUser);
        ...
        {
            var role = dataGridView.SelectedRows[0].DataBoundItem as ProductLD;

            var newProduct = new ProductLDForm(role.Id, currentUser);
            var result = newProduct.ShowDialog();
